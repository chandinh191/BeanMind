...
namespace Application.Enrollments.Queries
{
    ...
    public sealed record GetPaginatedListEnrollmentQueryV2 : IRequest<BaseResponse<Pagination<GetBriefEnrollmentResponseModel>>>
    {
    ...
    public class GetPaginatedListEnrollmentQueryV2Handler : IRequestHandler<GetPaginatedListEnrollmentQueryV2, BaseResponse<Pagination<GetBriefEnrollmentResponseModel>>>
    {
        ...
        public async Task<BaseResponse<Pagination<GetBriefEnrollmentResponseModel>>> Handle(GetPaginatedListEnrollmentQueryV2 request, CancellationToken cancellationToken)
        {
